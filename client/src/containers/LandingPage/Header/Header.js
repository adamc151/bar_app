    ...
    return (
      <div className={classes.join(" ")}>
        <div className="HeaderMaxWidth">
          ...
          <Aux>
            <a href="https://twitter.com/hapihour_io" className="HeaderItem HeaderSocial">
            ...
            <a href="https://www.instagram.com/hapihour.io/" className="HeaderItem HeaderSocial">
            ...
            <a href="https://www.facebook.com/hapihour.io" className="HeaderItem HeaderSocial">
